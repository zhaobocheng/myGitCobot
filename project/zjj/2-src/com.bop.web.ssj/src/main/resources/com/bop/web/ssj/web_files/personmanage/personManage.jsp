...
var url = "/ssj/personmanage/PersonManage/getSelectedGridData/ss?theme=none&nd="+zfnd.value;
var url2 = "/ssj/personmanage/PersonManage/getUnSelectedGridData/ss?theme=none&nd="+zfnd.value;
...
search = function(e){
	...
	if(e=="un"){
		...
		var url = "/ssj/personmanage/PersonManage/getUnSelectedGridData/"+recordId.id+"?theme=none&key="+key+"&nd="+nd;
		ungrid.setUrl(url);
		ungrid.load();
	}else{
		var key=mini.get("selectkey").value;
		var url = "/ssj/personmanage/PersonManage/getSelectedGridData/"+recordId.id+"?theme=none&key="+key+"&nd="+nd;
		grid.setUrl(url);
		grid.load();
	}
}
